$(function(){
	...
	var SizeEditor = Marionette.ItemView.extend({
		...
		applyValue: function(item, state){
			item[this.args.column.field].stockQy = parseInt(state, 10) || 0;
		},
...
//			'click #ca_table_thead span.closeIcon'	:	'_onHeaderClick',		// 「×」押下
//			'click #ca_viewAll'				:	'_onViewAllClick',		// 「全て表示」押下
//			'change .cl_stockQy'			:	'_onStockQyChange',		// 「基準在庫数」変更
		},
		...
		initialize: function(opt){
			...
			var mdBaseViewOpt = _.bind(function(o){
				var mdOpt = {
					...
					btn_csv: (o.opeTypeId == am_proto_defs.AM_PROTO_COMMON_RTYPE_UPD)
					? true : false,
...
//			this.setTableByBodyShape(rowID);
...
//			// 体型セレクタの選択をクリア
//			$("#ca_bodyShapeID").selectpicker('val', clutil.cStr(0));
//
...
//		},
		...
		_buildGetReqFunction: function(opeTypeId, pgIndex){
			...
			return {
				resId: 'AMDSV0040',	//clcom.pageId,	//TODO
				data: getReq
			};
		},
