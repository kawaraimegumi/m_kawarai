...
//			});
			...
			this.CAPAV0090Panel.isValidCond = _.bind(function(anaproc){
				...
				if(anaproc.cond.vAxisList.length <= 1){
					// TODO: 軸セレクタ側で、２軸めも必須チェックとしたい。
					var msg = '縦軸２を設定してください。';
	...
	anaProc.iniGet().done(_.bind(function(){
		...
		c.vAxisList = [
			// TODO: 縦軸初期設定 - 超ハードコーディングなのでなんとかする！！！
			{
				attr: 0,
				func_id: 0,
				kind: amanp_AnaDefs.AMAN_DEFS_KIND_BASKET_GG, //1011,
				name: "",
				name2: "バスケット 品種"
			},
			{
				attr: 0,
				func_id: 0,
				//kind: amanp_AnaDefs.AMAN_DEFS_KIND_BASKET_II,//1013,
				//name: "",
				//name2: "バスケット 商品"
				kind: amanp_AnaDefs.AMAN_DEFS_KIND_BASKET_GG, //1011,
				name: "",
...
//				// 0x1710f2: itemId[0xf2] name[比較商品レシート枚数実績]
//				dispItemId: amanp_AnaDispItemDefs.AMAN_DI_I_BASKET_RCPT2_NUM,
//				sbit: amanp_AnaDispItemDefs.AMAN_DI_S_VAL
//			},{
