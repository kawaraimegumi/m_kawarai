/**
 * このファイルは自動生成されたものです。これを直接編集せずに build/src/js/ui-folder/*.js を編集してください。
 */
        ...
        init: function (e) {
            ...
            if (this.options.size == 'auto') {
                function getSize() {
                	...
                	// shimizu追加 2013/12/09
                    menuHeight = menuHeight > 241 ? 241 : menuHeight;
                	// shimizu追加 2013/12/09
  ...
  $(function() {
    ...
    if ($slider.length) {
      $slider.slider({
    	...
    	//placeholder.jsはずしたのでコメントアウト 12/18ふじおか
