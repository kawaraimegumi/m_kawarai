$(function() {
	...
	//////////////////////////////////////////////
	// View
	CACMV0360SelectorView = Backbone.View.extend({
		...
		// 押下イベント
		events: {
			"click #ca_CACMV0360_commit"			:	"_onCommitClick",		// 確定ボタン押下

			"click #ca_CACMV0360_main .close"		:	"_onCancelClick",	// 閉じるボタン押下時
			"click #ca_CACMV0360_cancel"			:	"_onCancelClick",	// キャンセルボタン押下時
			"click #ca_CACMV0360_main .modalBK"		:	"_onCancelClick"	// 枠外押下時
		},
		...
		typeRadioViews: [
			{
				options: {
					...
					anaFocusKind: amanp_AnaDefs.AMAN_DEFS_KIND_ITEMATTR_SMXKT
				},
				view: null
			}
		],
...
//			this.$el.html('');
			...
			$('.cl_echoback').hide();
			// validatorエラー時の表示領域
			this.validator = clutil.validator(this.$('#ca_CACMV0360_main'), {
		...
		// Idより選択されたデータを取得
		getData : function(){
			//var editList = clutil.view2data(this.$('#ca_CACMV0360_searchArea'), 'ca_CACMV0360_');
