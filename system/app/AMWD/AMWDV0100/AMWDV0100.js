...
$(function() {
	...
	var MainView = Backbone.View.extend({
		...
		events: {
			...
			"change input[name='ca_srchTermSw']:radio"  : "onSelChange",			//一覧種別ラジオボタン変更
		...
		initUIElement: function(){
			...
			var lastDate = clutil.addDate(opeDate, -1);
			...
			// 出力対象基準日
			clutil.datepicker($("#ca_srchBaseYmd"));
			$("#ca_srchBaseYmd").datepicker('setIymd', opeDate);
...
//					});
		...
		doCSVDownload: function(rtyp){
			...
			var defer = clutil.postDLJSON('AMWDV0100', srchReq);
