...
$(function () {
  ...
  const MainView = Backbone.View.extend({
    ...
    initialize: function () {
      ...
      bbutil.yearSelector({ $select: this.$('#入金年from') });
      bbutil.monthSelector({ $select: this.$('#入金月from') });
      bbutil.yearSelector({ $select: this.$('#入金年to') });
      bbutil.monthSelector({ $select: this.$('#入金月to') });
