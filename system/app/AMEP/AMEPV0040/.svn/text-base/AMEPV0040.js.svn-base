$(function() {
	...
	var CsvOutView = Backbone.View.extend({
		...
		initialize: function(){
			...
			clutil.datepicker(this.$("#ca_fromDate")).datepicker("setIymd", clcom.getOpeDate());
		...
		initUIelement : function(){
			...
			this.opeCSVInputCtrl = clutil.View.OpeCSVInputController({
				...
				buildCSVInputReqFunction: _.bind(function(uploadedFile){
					// リクエストデータ本体
					var request = {
							AMEPV0040UpdReq: clutil.view2data(this.$("#ca_searchArea"))
					};
		...
		doDownload: function(rtyp) {
			...
			var defer = clutil.postDLJSON('AMEPV0040', srchReq);
