...
//			});
			...
			this.fieldRelation = clutil.FieldRelation.create('subclass', {
				...
				dataSource: {
					iagfunc_id1: AMMSV1090define.ITEMATTRGRPFUNC_ID_SUBCLS1,
					iagfunc_id2: AMMSV1090define.ITEMATTRGRPFUNC_ID_SUBCLS2,
				}
			});
...
//				],
			...
			// グループID -- AMMSV1090 なデータに関連することを表すためのマーキング文字列
			var groupid = 'AMMSV1090';
...
//						break;
		...
		doSrch: function(srchReq, selectedIds, $focusElem){
			...
			var defer = clutil.postJSON('AMMSV1090', srchReq).done(_.bind(function(data){
				//console.log(arguments);
...
console.log("DEBUG: outTypeID=" + srchReq.AMMSV0090GetReq.outTypeID);
			...
			var defer = clutil.postDLJSON('AMMSV1090', srchReq);
		...
		doTagApply: function(chkData) {
			...
			clutil.postJSON('AMMSV1090', applyReq).done(_.bind(function(data){
				var e = null;
