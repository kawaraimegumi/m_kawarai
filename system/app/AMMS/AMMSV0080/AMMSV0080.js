...
//			});
		...
		_buildSubmitReqFunction: function(opeTypeId, pgIndex){
			...
			var materialList = this._buildUpdReqAMMSV0080MaterialList(item);
			var photoList = this._buildUpdReqAMMSV0080PhotoList(item);
		 ...
		 * @returns {Array}
		 */
		_buildUpdReqAMMSV0080MaterialList: function(item) {
		 ...
		 * @returns
		 */
		_buildUpdReqAMMSV0080PhotoList: function(item) {
			var list = [];
