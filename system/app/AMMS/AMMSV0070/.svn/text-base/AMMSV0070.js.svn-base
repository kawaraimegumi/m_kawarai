...
//			});
	...
	var MainView = Backbone.View.extend({
		...
		initialize: function(){
			...
			// グループID -- AMMSV0070 なデータに関連することを表すためのマーキング文字列
			var groupid = 'AMMSV0070';
...
//			'click #ca_rsvcancel'			: '_onReserveCancelClick'	// 予約取消ボタン押下
		...
		doSrch: function(srchReq, selectedIds, $focusElem){
			...
			var defer = clutil.postJSON('AMMSV0070', srchReq).done(_.bind(function(data){
				//console.log(arguments);
		...
		_doOpeAction: function(rtyp, e){
			var url = clcom.appRoot + '/AMMS/AMMSV0080/AMMSV0080.html';
			var myData, destData;
			if(this.savedReq){
				// 検索結果がある場合
				myData = {
