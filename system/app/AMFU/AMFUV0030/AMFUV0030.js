...
//			clutil.clmonthselector(this.$("#ca_srchYm"), 0, 1, null, null, null, 1); //初期表示調整(とりあえず1年)
...
//				cond : srchDto
		...
		doCSVDownload: function(rtyp) {
			...
			var defer = clutil.postDLJSON('AMFUV0030', srchReq);
