...
$(function() {
	...
	//////////////////////////////////////////////
	// View
	var AMIGV0090View = Backbone.View.extend({
		// 要素
		el					:$("#ca_main"),
		...
		doDownload: function(rtyp){
			...
			var defer = clutil.postDLJSON('AMIGV0090', srchReq);
	...
	clutil.getIniJSON(null).done(function(data){
		// ここで、clcom の内容が保証される /////////////////
		mainView = new AMIGV0090View().initUIElement().render();
		mainView.setFocus();
	}).fail(function(data){
