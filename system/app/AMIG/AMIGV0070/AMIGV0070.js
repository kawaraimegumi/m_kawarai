...
$(function() {
	...
	//////////////////////////////////////////////
	// View
	var AMIGV0070View = Backbone.View.extend({
		// 要素
		el					:$("#ca_main"),
...
//			var _this = this;
		...
		doDownload: function(rtyp){
			...
			var defer = clutil.postDLJSON('AMIGV0070', srchReq);
	...
	clutil.getIniJSON(null).done(function(data){
		// ここで、clcom の内容が保証される /////////////////
		mainView = new AMIGV0070View().initUIElement().render();
		mainView.setFocus();
	}).fail(function(data){
