$(function(){
	...
	var SrchCondView = Backbone.View.extend({
		el: $('#ca_srchArea'),
		events: {
			'change #ca_srchDate': function(e){
				// Datepicker 変更イベント
				console.log('change: ', arguments);
			},
			'clDatepickerOnSelect #ca_srchDate': function(e){
				// Datepicker 選択イベント
				console.log('clDatepickerOnSelect: ', arguments);
			},
...
//			'click #ca_rsvcancel'			: '_onReserveCancelClick'	// 予約取消ボタン押下
		...
		render: function() {
			 ...
			 */
			var columns = [
				{ id: 'ca_01', name: "Title", field: "title", width: 200, resizable: true },
				{ id: 'ca_02', name: 'Duration', field: 'duration', width: 80, resizable: !true },
				{ id: 'ca_03', name: "% Complete", field: "percentComplete", cssClass: 'txtalign-right', width: 80, resizable: true },
				{ id: 'ca_04', name: "Start", field: "start", cssClass: 'txtalign-center', width: 100, resizable: !true },
				{ id: 'ca_05', name: "Finish", field: "finish", cssClass: 'txtalign-center', width: 100, resizable: !true },
				{ id: 'ca_06', name: "Effort Driven", field: "effortDriven", cssClass: 'txtalign-center', width: 80, resizable: true }
			];
